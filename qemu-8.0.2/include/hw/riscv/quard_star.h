...
#define QUARD_STAR_PLIC_PRIORITY_BASE  0x04     // PLIC 中断优先级寄存器的基地址偏移值，用于访问中断优先级信息
...
#define QUARD_STAR_PLIC_CONTEXT_STRIDE 0x1000   // PLIC 上下文保存寄存器之间的地址间隔，用于访问不同上下文的保存寄存器
